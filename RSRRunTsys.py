...
class RSRRunTsys():
	...
	tsys = numpy.median (tsys_data)
        ...
        pl.annotate("Average Tsys =%6.2fK on  Chassis %d"%(tsys,use_chassis), [114,tsys-1], fontsize=13, fontweight='bold', stretch='250', horizontalalignment='right', verticalalignment='top')
