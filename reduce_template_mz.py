...
Obslist=[21452, 21453, 21455, 21456, 21458, 21459, 21461, 21462, 21464, 21465, 21467, 21468, 21471, 21472, 21474, 21475, 21477, 21478, 21480, 21481]
...
Obslist=[21370,21371,21373, 21374, 21376, 21377]

for ObsNum in Obslist:
    for chassis in (0,1,3):

        totalChassis +=1
        filename= '/data_lmt/RedshiftChassis%d/RedshiftChassis%d_2014-05-25_%06d_00_0001.nc' % (chassis, chassis, ObsNum)
...
Obslist=[21344, 21345, 21347, 21348, 21350, 21351, 21353, 21354]

for ObsNum in Obslist:
    for chassis in (0,1,3):

        totalChassis +=1
        filename= '/data_lmt/RedshiftChassis%d/RedshiftChassis%d_2014-05-24_%06d_00_0001.nc' % (chassis, chassis, ObsNum)
